...
\title[]{Data, data, data everywhere...}
\subtitle{What every psychologist should know about data science?}
...
\begin{frame}{General interest in data science}
    \begin{figure}
    \includegraphics[width = .7\framewidth]{png/ds-searches.png}
...
\begin{frame}
    ...
    \only<+>{
        \begin{itemize}
            ...
            \item<0> tokenization
            \item<0> stemming
            \item<0> lemmatization
            \item<0> vector models
            \item<0> topic modeling
            \item<0> part of speech tagging
            \item<0> entities analysis
    \end{itemize}
    }
